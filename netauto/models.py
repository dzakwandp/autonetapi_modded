...
class AttackLog(models.Model):
    hash_id = models.CharField(max_length=256, verbose_name='Hash ID', blank=True)
    time = models.DateTimeField(null=True, verbose_name='Time')
    detection_time = models.CharField(null=True, max_length=200, verbose_name='Detection time')
    #detection_time = models.DateTimeField(null=True, verbose_name='Detection time')
...
class ExecTime(models.Model):
    exec_name = models.CharField(max_length=200)
    time = models.CharField(max_length=32)
    comment = models.CharField(max_length=200)

    def __str__(self):
        return "{} - {} - {}".format(self.exec_name, self.comment, self.time)
