...
from netauto.apiclient import report_api
        ...
        for idx in j:
            ...
            if N[0][idx][1] is True and N[1][idx][1] is True and N[2][idx][1] is True and N[3][idx][1] is True:
                try:
                    ...
                    log = Log(target=detector_instance.device.ip_address, action="Detection", status="POSITIVE",
                            time=datetime.now(),
                ...
                try:
                    ...
                    log = Log(target=detector_instance.device.ip_address, action="Detection", status="NEGATIVE",
                            time=datetime.now(),
